        ...
        <div class="w-64 bg-white border-r border-gray-200 flex flex-col fixed h-full">
            ...
            <div class="h-16 px-4 border-b border-gray-200 flex items-center">
                <a href="{{ route('dashboard') }}" class="flex items-center">
                    ...
                    <span class="ml-3 text-lg font-medium text-gray-900">Admin Panel</span>
                </a>
            </div>
            ...
            <nav class="flex-1 overflow-y-auto px-3 py-4">
                <div class="space-y-1">
                    ...
                    <a href="{{ route('feedback.index') }}" class="flex items-center px-3 py-2 text-sm font-medium rounded-lg {{ request()->routeIs('feedback.*') ? 'bg-blue-50 text-blue-600' : 'text-gray-700 hover:bg-gray-50' }}">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('inspirations.index') }}" class="flex items-center px-3 py-2 text-sm font-medium rounded-lg {{ request()->routeIs('inspirations.*') ? 'bg-blue-50 text-blue-600' : 'text-gray-700 hover:bg-gray-50' }}">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('pages.index') }}" class="flex items-center px-3 py-2 text-sm font-medium rounded-lg {{ request()->routeIs('pages.*') ? 'bg-blue-50 text-blue-600' : 'text-gray-700 hover:bg-gray-50' }}">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="flex items-center flex-1">
                        <div class="flex-1 max-w-2xl">
                            <div class="relative">
                                ...
                                <input type="text" class="w-full pl-10 pr-4 py-2 border-0 text-sm text-gray-900 placeholder-gray-500 focus:ring-0" placeholder="Search...">
                            </div>
                        </div>
                    </div>
