...
<div class="max-w-4xl mx-auto py-6">
    <div class="md:flex md:items-center md:justify-between mb-6">
        <div class="flex-1 min-w-0">
            <h2 class="text-2xl font-semibold text-gray-900 leading-7">Add AI Model</h2>
        </div>
    ...
    <div class="bg-white shadow overflow-hidden sm:rounded-lg">
        <form action="{{ route('ai-models.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6 p-6">
            @csrf
            ...
            <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <div class="mt-1">
                        <input type="text" name="name" id="name" class="shadow-sm focus:ring-blue-500 focus:border-blue-500 block w-full sm:text-sm border-gray-300 rounded-md @error('name') border-red-300 text-red-900 placeholder-red-300 focus:outline-none focus:ring-red-500 focus:border-red-500 @enderror" value="{{ old('name') }}" required>
                    </div>
                    @error('name')
                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <div class="mt-1">
                        <select name="ai_model_type" id="ai_model_type" class="shadow-sm focus:ring-blue-500 focus:border-blue-500 block w-full sm:text-sm border-gray-300 rounded-md @error('ai_model_type') border-red-300 text-red-900 focus:outline-none focus:ring-red-500 focus:border-red-500 @enderror" required>
                            ...
                            <option value="Premium model" {{ old('ai_model_type') == 'Premium model' ? 'selected' : '' }}>Premium model</option>
                            <option value="Standard model" {{ old('ai_model_type') == 'Standard model' ? 'selected' : '' }}>Standard model</option>
                        </select>
                    </div>
                    @error('ai_model_type')
                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                ...
                <div>
                    ...
                    <div class="mt-1">
                        <select name="ios_model_type" id="ios_model_type" class="shadow-sm focus:ring-blue-500 focus:border-blue-500 block w-full sm:text-sm border-gray-300 rounded-md @error('ios_model_type') border-red-300 text-red-900 focus:outline-none focus:ring-red-500 focus:border-red-500 @enderror" required>
                            <option value="">Select Type</option>
                            <option value="Premium model" {{ old('ios_model_type') == 'Premium model' ? 'selected' : '' }}>Premium model</option>
                            <option value="Standard model" {{ old('ios_model_type') == 'Standard model' ? 'selected' : '' }}>Standard model</option>
                        </select>
                    </div>
                ...
                <div class="sm:col-span-2">
                    ...
                    <div class="mt-1">
                        <textarea name="prompt_engineering" id="prompt_engineering" rows="3" class="shadow-sm focus:ring-blue-500 focus:border-blue-500 block w-full sm:text-sm border-gray-300 rounded-md">{{ old('prompt_engineering') }}</textarea>
                    </div>
                ...
                <div>
                    ...
                    <div class="mt-1">
                        <select name="ad_type" id="ad_type" class="shadow-sm focus:ring-blue-500 focus:border-blue-500 block w-full sm:text-sm border-gray-300 rounded-md">
                            ...
                            <option value="Reward" {{ old('ad_type') == 'Reward' ? 'selected' : '' }}>Reward</option>
                        </select>
                    </div>
                    @error('ad_type')
                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                ...
                <div>
                    ...
                    <div class="mt-1">
                        <input type="number" name="delay" id="delay" class="shadow-sm focus:ring-blue-500 focus:border-blue-500 block w-full sm:text-sm border-gray-300 rounded-md @error('delay') border-red-300 text-red-900 placeholder-red-300 focus:outline-none focus:ring-red-500 focus:border-red-500 @enderror" value="{{ old('delay') }}" required>
                    </div>
                    @error('delay')
                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                ...
                <div class="sm:col-span-2">
                    ...
                    <div class="mt-1">
                        <input type="file" name="image" id="image" class="shadow-sm focus:ring-blue-500 focus:border-blue-500 block w-full sm:text-sm border-gray-300 rounded-md @error('image') border-red-300 text-red-900 placeholder-red-300 focus:outline-none focus:ring-red-500 focus:border-red-500 @enderror" accept="image/*" required>
                    </div>
                    @error('image')
                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    <div class="flex items-center">
                        <input type="checkbox" name="popularity" id="popularity" class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded" value="1" {{ old('popularity') ? 'checked' : '' }}>
                ...
                <div>
                    <div class="flex items-center">
                        <input type="checkbox" name="is_default" id="is_default" class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded" value="1" {{ old('is_default') ? 'checked' : '' }}>
                ...
                <div>
                    <div class="flex items-center">
                        <input type="checkbox" name="status" id="status" class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded" value="1" {{ old('status', true) ? 'checked' : '' }}>
