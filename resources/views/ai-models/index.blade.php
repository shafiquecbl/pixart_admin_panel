        ...
        <div class="flex items-center space-x-8">
            ...
            <div class="w-96">
                ...
                <div class="relative">
                    ...
                    <input type="search" name="search" id="search" class="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md text-sm placeholder-gray-500 focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500" placeholder="Search by ID or name">
                </div>
            </div>
        </div>
